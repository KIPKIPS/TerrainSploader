...
public class LightingMapData : MonoBehaviour {
    public FogInfo fogInfo;
    public List<RendererInfo> rendererInfoList;
    public LightmapsMode lightingMapsMode;
    ...
    public void SetUp() {
        LoadLightmap();
        LightmapSettings.lightmapsMode = lightingMapsMode;
    ...
    public void SaveLightingMap() {
        ...
        rendererInfoList = new List<RendererInfo>();
        ...
        lightingMapsMode = LightmapSettings.lightmapsMode;
    }
    private void LoadLightmap() {
        ...
        if (rendererInfoList.Count > 0) {
            foreach (var item in rendererInfoList) {
